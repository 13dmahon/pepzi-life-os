...
import { Mountain, Mail, Lock, User, ArrowRight, Eye, EyeOff, Check } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After email/password signup, send them into onboarding.
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="backdrop-blur-2xl bg-white/70 border border-white/80 rounded-3xl p-8 shadow-xl">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-slate-700 mb-2">Start your journey</h1>
            <p className="text-slate-400">Create an account to reach your summit</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 px-4 py-3.5 bg-slate-800 text-white rounded-2xl font-semibold hover:bg-slate-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-6"
            >
              {loading ? (
